...
// ============================================================
// Anvesha - SAP FI Skill Extraction & Candidate Match Validation
// Flow: Open App → New Search → Type query with "SAP FI" →
//       Submit → Interpretation card → Validate skill chip →
//       Search Candidates → Hover on Match % → Verify tooltip
//       shows "sap fi" (matched) and NOT "need:sap fi" (unmatched)
// ============================================================

// Natural language query mentioning the niche skill "SAP FI"
const searchQuery = 'developer with green field skills';

// The must-have skill we specifically expect Anvesha to extract
const expectedSkill = 'green field development';

test.describe('Anvesha - Green field Skill Extraction & Candidate Match', () => {

    test('Verify Green field is extracted and matched candidates show "green field" (not "need:green field") on hover', async ({ page }) => {
        ...
        // Step 2: Type the natural language query containing "SAP FI" into the search input
        ...
        // Step 5: Validate that "sap fi" is extracted as a must-have skill chip
        ...
        //   <span class="match-cell" data-reason="1/1 mandatory skills matched (sap fi); X yrs experience">N%</span>
        ...
        // Assert: data-reason should NOT contain "need:sap fi" (which means skill is missing)
