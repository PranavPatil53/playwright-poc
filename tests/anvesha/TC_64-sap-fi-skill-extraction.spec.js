...
const searchQuery = 'developer with SAP FI skill';

// The must-have skill we specifically expect Anvesha to extract
const expectedSkill = 'sap fi';

test.describe('Anvesha - SAP FI Skill Extraction & Candidate Match', () => {

  test('Verify SAP FI is extracted and matched candidates show "sap fi" (not "need:sap fi") on hover', async ({ page }) => {
